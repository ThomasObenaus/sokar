...
test: sep gen-mocks ## Runs all unittests and generates a coverage report.
	...
	@go test ./scaleschedule ./config ./alertmanager ./nomad ./logging ./scaler ./helper ./scaleAlertAggregator ./sokar ./capacityPlanner ./aws ./awsEc2 ./nomadWorker ./api ./ -covermode=count -coverprofile=coverage.out
