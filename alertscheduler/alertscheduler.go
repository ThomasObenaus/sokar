...
//				if as.shouldFireAlert(time.Now()) {
//					as.logger.Info().Msg("Fire scheduled scaling alert")
//				}
//			}
//		}
...
//}
//
//func (as *AlertScheduler) shouldFireAlert(now time.Time) bool {
//
//	day := now.Weekday()
//	hour := now.Hour()
//	minute := now.Minute()
...
//
//	if err != nil {
//		as.logger.Warn().Msgf("Could not evaluate scaling schedule: %s", err.Error())
//		return false
//	}
//
//	return as.schedule.IsActiveAt(day, at)
//}
//
//func (as *AlertScheduler) fireScaleAlertPacket(emitter string, scalingAlerts saa.ScaleAlertPacket) {
//	for _, handleFunc := range as.handleFuncs {
